package uk.co.shadowtrilogy.hardcore24.json.world_group;
...
public class World_groupJSON {
    public static worldgroupdataContainer jsonInit(File JSON_FILE, HashMap<String, String> defaultMap) {
        ...
        try {
            if (JSON_FILE!=null){
                ...
                if(tempstr.isEmpty()){
                    return new worldgroupdataContainer(defaultMap);

                }


                worldgroupdataContainer data = new Gson().fromJson(tempstr, worldgroupdataContainer.class);
    ...
    public static void jsonSave(worldgroupdataContainer toJson, File JSON_FILE){
