...
public class Player_dataJSON {

    public static playerdataContainer jsonInit(File JSON_FILE, HashMap<UUID, PlayerDeathData> defaultMap) {
        ...
        try {
            if (JSON_FILE!=null){
                ...
                if(tempstr.isEmpty()){
                    return new playerdataContainer(defaultMap);

                }


                playerdataContainer data = new Gson().fromJson(tempstr, playerdataContainer.class);
    ...
    public static void jsonSave(playerdataContainer toJson, File JSON_FILE){
